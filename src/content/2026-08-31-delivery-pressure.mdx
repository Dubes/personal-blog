...
excerpt: 'Delivery pressure is not new to our industry, but sustained delivery pressure is. We are handling it poorly and it is having consequences, increased burnout, exploding tech debt and much more. Delivery pressure is not a problem that can be overcome with hard work alone; it is an analytical problem that requires strategy and meaningful change. In this post, I will cover some common anti-patterns I have seen and some hints on where to start looking, with deeper dives in following blog posts'
---
...
Many a time I have seen leaders at all level try to protect people by shielding them from context, decisions not yet made final, problems that might or might not land. Or they just want the team to focus, so they don't invite the team members to the meetings. The thinking is kind: do not burden them. But the people in your team are _knowledge workers_. They _need_ information. By shielding them, you are depriving them of a vital tool. You cannot overcome this alone. You will need your team, but you will have to lead them.
...
Often I have seen people hyperfocus on the most visible and the easiest to measure metrics, such as, _Velocity_ or _Capacity_ or , in the recent days, _Tokenmaxxing_. Because they are easy to measure, they are also easy to game. If you are constantly pushing your team to increase velocity without doing a real inspect and adapt cycle, the result is what used to be marked as 3 story points become a 5, the 5s become 8s and so on and so forth. 
