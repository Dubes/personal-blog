...
excerpt: 'Delivery pressure is not new to our industry, but sustained delivery pressure is. We are handling it poorly and it is having consequences, more burnout, exploding tech debt and overall enshittification of the products and solutions. Delivery pressure is not a problem that can be overcome with hard work alone; it is an analytical problem that requires strategy and meaningful change to solve. In this post, I will cover some common anti-patterns I have seen and some hints on where to start looking, with deeper dives in following blog posts'
---
...
![A movie still of Kylo Ren menacingly screaming more](../assets/img/kylo_ren_screaming_more.webp)
...
This is an extension of the point above. I have seen huge architectural and process changes being made without even consulting the team. The decision is made 3 to 4 layers above and then communicated as directives in a cascading manner. There are a lot of downsides of doing it. No buy-in from the people you need to make it happen. Finger pointing / lack of accountability, people adjusting their performance to meet expectations. If you treat your developers as mere code-outputting humans, they will stop being developers and perform as coders. 
...
The biggest resistance to fixing delivery pressure comes from rework. The things you delivered in the past come back as bugs or change requests. This rework breaks [flow](https://en.wikipedia.org/wiki/Flow_(psychology)), trust and, in extreme cases, morale. If you find yourself fire fighting and/or task forcing more and more with each passing week, your quality strategy is probably the best place to start inspecting. 

_Side Note:_ Quality strategy isn't just about tests and automated suites. Quality needs to be ensured across all phases of SDLC (Software Development Life Cycle), from feature discovery to things running in production. Do not underestimate the damage caused by bad requirements and struggling support teams. Your improvements also need to work for these functions!
...
Every individual has their strengths and their blind spots. People perform best when their strengths are allowed to shine. This is the entire premise of [Clifton StrengthsFinder](https://www.gallup.com/cliftonstrengths/en/253790/science-of-cliftonstrengths.aspx). Are your people, especially those with leadership responsibilities, still playing to their strengths?
